...
class MyTestCase(unittest.TestCase):
    ...
    def test_director_byId(self):
        connex_app.app.testing=True
        data = connex_app.app.test_client(self)
        response = data.get("/api/director/4774")
        self.assertEqual(response.status_code, 200)
    ...
    def test_director_byId_false(self):
        connex_app.app.testing=True
        data = connex_app.app.test_client(self)
        response = data.get("/api/director/4")
    ...
    def test_director_byGender(self):
        connex_app.app.testing=True
        data = connex_app.app.test_client(self)
        response = data.get("/api/director/gender/2")
        self.assertEqual(response.status_code, 200)
    ...
    def test_movies_byId(self):
        ...
        response = data.get("/api/director/7109/movies/48398")
        self.assertEqual(response.status_code, 200)
    ...
    def test_movies_byId_false(self):
        connex_app.app.testing=True
        data = connex_app.app.test_client(self)
        response = data.get("/api/director/3/movies/3")
        self.assertEqual(response.status_code, 404)
    ...
    def test_movies_budget(self):
        connex_app.app.testing=True
        data = connex_app.app.test_client(self)
        response = data.get("/api/movies/budgetMore/9000")
        self.assertEqual(response.status_code, 200)
    ...
    def test_movies_budget_false(self):
        connex_app.app.testing=True
        data = connex_app.app.test_client(self)
        response = data.get("/api/movies/budgetMore/str")
        self.assertEqual(response.status_code, 404)
